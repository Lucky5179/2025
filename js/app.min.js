( () => {
    ...
    let i = (t, e=!1, s=500, o=0) => {
        ...
        if (a) {
            ...
            if (document.documentElement.classList.contains("menu-open") && c(),
            ...
            n(`[gotoBlock]: Йой... Такого блоку немає на сторінці: ${t}`)
    }
    ;
    t.watcher = new class {
        constructor(t) {
                ...
                r(Array.from(t).map((function(t) {
                    ...
                    let s = e.split("|")
                      ...
                      , a = Array.from(t).filter((function(t) {
                        ...
                        if (String(e) === o.root && String(s) === o.margin && String(a) === o.threshold)
                            return t
                    }
                    ))
        ...
        scrollWatcherCallback(t, e) {
            ...
            s.hasAttribute("data-watch-once") && t.isIntersecting && this.scrollWatcherOff(s, e),
    ...
    async function d() {
        try {
            const t = "F4Tph9ggvRQ2Yg5pBM8ifai5jHoMVBdYiVmYCBTmpump";
    ...
    new class {
        ...
        init() {
            ...
            this.mediaQueries = this.оbjects.map(( ({breakpoint: t}) => `(${this.type}-width: ${t}px),${t}`)).filter(( (t, e, s) => s.indexOf(t) === e)),
        ...
        moveTo(t, e, s) {
            ...
            "last" === t || t >= s.children.length ? s.append(e) : "first" !== t ? s.children[t].before(e) : s.prepend(e)
        }
        moveBack(t, e, s) {
    ...
    document.querySelector(".icon-menu") && document.addEventListener("click", (function(t) {
        s && t.target.closest(".icon-menu") && (( (t=500) => {
    ...
    function() {
            ...
            if ("click" === e.type) {
                ...
                if (s.closest("[data-goto]")) {
                    ...
                    if (t.fullpage) {
                        ...
                        null !== s && (t.fullpage.switchingSection(s),
        ...
        if (document.addEventListener("click", s),
    ...
    function() {
        ...
        document.addEventListener("windowScroll", (function(n) {
            ...
            clearTimeout(a),
            r >= o ? (!t.classList.contains("_header-scroll") && t.classList.add("_header-scroll"),
            ...
            ), s))) : (t.classList.contains("_header-scroll") && t.classList.remove("_header-scroll"),
